  ...
  return (
    <SectionWrapper id="contact" className="bg-white/50 dark:bg-gray-950/50 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] sm:w-[600px] h-[200px] sm:h-[300px] bg-gradient-to-r from-blue-500/4 via-purple-500/4 to-pink-500/4 dark:from-blue-500/8 dark:via-purple-500/8 dark:to-pink-500/8 rounded-full blur-2xl transform-gpu" />
      </div>
